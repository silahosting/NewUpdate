...
TIMES="10"
CHATID="7019487697"
KEY="7963569254:AAFbFdAbWGivtwALvKOLmJT-KJi54vv6rro"
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/silahosting/NewUpdate/main/regis | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/silahosting/NewUpdate/main/regis | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/silahosting/NewUpdate/main/regis | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/silahosting/NewUpdate/main/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/silahosting/NewUpdate/main/regis | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/silahosting/NewUpdate/main/regis | grep $ipsaya | awk '{print $3}')
...
wget raw.githubusercontent.com/silahosting/NewUpdate/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
